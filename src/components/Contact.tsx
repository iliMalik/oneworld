    ...
    <div className="bg-gray-50 dark:bg-neutral-900" id="contact">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 text-center">
        ...
        <p className="pt-6 pb-6 text-base max-w-2xl text-center m-auto dark:text-neutral-400">
          ...
          you how One World can transform your property management experience.
        </p>
      </div>

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-16 grid md:grid-cols-2 lg:grid-cols-2 gap-y-8 md:gap-x-8 md:gap-y-8 lg:gap-x-8 lg:gap-y-16">
        <div>
          {/* <h2 className="text-lg font-bold">Contact ONE WORLD</h2> */}
          {/* <p className="max-w-sm mt-4 mb-4 dark:text-neutral-400">
            Have something to say? We are here to respond. Fill up the form or
            send email or call phone.
          </p> */}

          <div className="flex items-center mt-8 space-x-2 text-dark-600 dark:text-neutral-400">
            <MapIcon className="w-4 h-4" />
            <span>1756 60th Street, Brooklyn, NY, 11204</span>
          </div>

          <div className="flex items-center mt-2 space-x-2 text-dark-600 dark:text-neutral-400">
            <EnvelopeIcon className="w-4 h-4" />
            <a href="mailto:hello@halley.vercel.app">hello@owproperty.com</a>
          </div>

          <div className="flex items-center mt-2 space-x-2 text-dark-600 dark:text-neutral-400">
            <PhoneIcon className="w-4 h-4" />
            <a href="tel:51931999999">+1 xxx-xxx-xxxx</a>
          </div>
        </div>
